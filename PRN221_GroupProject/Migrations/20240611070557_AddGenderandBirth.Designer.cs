...
namespace PRN221_GroupProject.Migrations
{
    ...
    [Migration("20240611070557_AddGenderandBirth")]
    partial class AddGenderandBirth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.CartDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "CartDetailId" }, "IX_CartDetail")
                        .IsUnique();
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.CartHeader", b =>
                {
                    ...
                    b.HasIndex(new[] { "CartId" }, "IX_CartHeader")
                        .IsUnique();
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.Coupon", b =>
                {
                    ...
                    b.HasIndex(new[] { "CouponId" }, "IX_Coupon")
                        .IsUnique();
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "OrderHeaderId" }, "IX_OrderHeader")
                        .IsUnique();
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.CartDetail", b =>
                {
                    b.HasOne("PRN221_GroupProject.Models.CartHeader", "Cart")
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.CartHeader", b =>
                {
                    b.HasOne("PRN221_GroupProject.Models.ApplicationUser", "User")
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.Category", b =>
                {
                    b.HasOne("PRN221_GroupProject.Models.ApplicationUser", "CreatedByNavigation")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.OrderDetail", b =>
                {
                    b.HasOne("PRN221_GroupProject.Models.OrderHeader", "OrderHeader")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderHeaderId")
                        .HasPrincipalKey("OrderHeaderId")
                        .IsRequired()
            ...
            modelBuilder.Entity("PRN221_GroupProject.Models.OrderHeader", b =>
                {
                    b.HasOne("PRN221_GroupProject.Models.Coupon", "Coupon")
